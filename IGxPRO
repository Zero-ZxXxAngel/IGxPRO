...
echo ""
echo -e $okegreen "IGxPRO will continue , but some of its functions may not work properly."
echo ""
...
echo ""
echo -e $okegreen "IGxPRO will continue , but many of its functions will not work properly."
echo ""
echo -e $okegreen "Press [ENTER] key to continue"
read continue
cont
...
echo ""
    ...
    echo ""
echo -e $green "If you want to Install IGxPRO on a remote computer then "
...
echo -e "\t "$green"¦----"$red"►  "$white" Github   "$green": "$BlueF"www.github.com/Zero-ZxXxAngel  \n\n"
}
...
fu_un_info_setup () { #
		...
		echo -e "\t"$green"¦ Information"
		echo -e "\t"$green"¦"
		echo -e "\t"$green"¦––––$red►"$green" Setup your wordlist  "
		echo -e "\t"$green"¦––––$red►"$green" Create a spesific wordlist for attack \n\n"
}
...
fu_un_info_attack () { #
		...
		echo -e "\t"$green"¦ Information"
		echo -e "\t"$green"¦"
		echo -e "\t"$green"¦––––$red►"$green" Attack service   "
		echo -e "\t"$green"¦––––$red►"$green" Bruteforce for attack \n\n"
}
...
f_un_info_credits () { #
		...
		echo -e "\t"$green"¦"
		echo -e "\t"$green"¦ Credits - Special Thanks to Allah "
		echo -e "\t"$green"¦"
  	...
  	echo -e "\t"$green"¦––––$red►"$green" Backbox indonesia ( www.www.backboxindonesia.or.id )  "
		...
		echo -e "\t"$green"¦––––$red►"$green" http://www.kitploit.com/"
		echo -e "\t"$green"¦––––$red►"$green" Big Thanks to : http://www.github.com/ \n\n"
}
...
sleep 1
echo ""
echo -e $yellow"[*] Thank You For Using IGxPRO  =)."
echo ""
...
fu_un_set_0x1 () {
	...
	echo -e " Available list:\n\n"
        echo -e "\t {0x1} alphabet_1.lst | Size : 23.8 mb"
        echo -e "\t {0x2} alphabet_2.lst | Size : 10.4 mb"
        echo -e "\t {0x3} alphabet_3.lst | Size : 16.5 mb"
        echo -e "\t {0x4} alphabet_4.lst | Size : 5.0  mb  "
        echo -e "\t {0x5} alphabet_5.lst | Size : 19.5 mb\n"
        read -p "choice: " mainchoice
        case $mainchoice in
	0x1) path=`pwd`
       infolist=$path/wlist/alphabet/alphabet_1.lst
	     lang='English'
	     rating='8.5'
	     desc='random'
	     echo -ne " \n\tset up wordlist complete " ; read p  && fu_un_set_0x1 ;;
	0x2) path=`pwd`
             infolist=$path/wlist/alphabet/alphabet_2.lst
	     lang='English'
	     rating='8.2'
	     desc='random'
	     echo -ne " \n\tset up wordlist complete " ; read p  && fu_un_set_0x1 ;;
	0x3) path=`pwd`
             infolist=$path/wlist/alphabet/alphabet_3.lst
	     lang='English'
	     rating='8.5'
	     desc='random'
	     echo -ne " \n\tset up wordlist complete " ; read p  && fu_un_set_0x1 ;;
	0x4) path=`pwd`
             infolist=$path/wlist/alphabet/alphabet_4.lst
	     lang='English'
	     rating='8.3'
	     desc='random'
	     echo -ne " \n\tset up wordlist complete " ; read p  && fu_un_set_0x1 ;;
	0x5) path=`pwd`
             infolist=$path/wlist/alphabet/alphabet_5.lst
	     lang='English'
	     rating='8.2'
	     desc='random'
	     echo -ne " \n\tset up wordlist complete " ; read p  && fu_un_set_0x1 ;;
...
fu_un_show_wlist () {
        ...
        f_un_ban && f_un_des
				echo -e " Available list:\n\n"
        echo -e "\t {0x1} Alphabet {random name} "
        echo -e "\t {0x2} league {league}"
        echo -e "\t {0x3} Date {date}"
        echo -e "\t {0x4} wordlist {password}"
